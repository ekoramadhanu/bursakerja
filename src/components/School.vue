        ...
        <v-col xl="12" lg="12" md="12" sm="12" xs="12">
          <v-card elevation="3" class="rounded-xl" width="100vw">
            <v-card-text class="pa-4">
              <p
                class="mb-2 font-weight-bold text-capitalize text-subtitle-1 black--text"
              >
                <span class="font-family"> kriteria </span>
              </p>
              <v-form lazy-validation class="mt-2">
                <v-row>
                  <v-col
                    cols="12"
                    lg="5"
                  ...
                  >
                    ...
                    <v-autocomplete
                      ...
                      item-text="name"
                      item-value="name"
                      label="Silahkan Ketik Kota Yang Anda Inginkan"
                      dense
                      outlined
                      single-line
                      class="font-family"
                  ...
                  >
                    <p class="mb-0 black--text text-capitalize">
                      <span class="font-family"> kategori</span>
                    </p>
                    <v-select
                      v-model="category"
                      :items="itemCategory"
    ...
    async methodGetSchool() {
      try {
        ...
        const response = await axios({
          baseURL: `${this.$store.state.domain}school/show-all/${this.page}`,
          method: 'get',
          headers: header,
        });
