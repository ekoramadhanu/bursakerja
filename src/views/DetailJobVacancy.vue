        ...
        <v-dialog v-model="dialogApplication" persistent max-width="550">
          <v-card>
            <v-card-title class="primary d-flex justify-space-between">
              ...
              <v-btn @click="dialogApplication = false" icon color="white">
                <v-icon>$close</v-icon>
              </v-btn>
            </v-card-title>
            <v-card-text>
            ...
            <v-card-actions>
              ...
              <v-btn color="primary" @click="sendApplication()" text>
                <v-progress-circular
                  indeterminate
                  color="primary"
...
export default {
  ...
  async beforeCreate() {
    try {
      ...
      if (response.data.data.attributes.length === 1) {
        this.image = response.data.data.attributes[0].company.brand;
        this.description = response.data.data.attributes[0].description;
        this.exerience = response.data.data.attributes[0].experience;
        this.nameJob = response.data.data.attributes[0].name;
        this.salary = response.data.data.attributes[0].salary;
        this.location = `${response.data.data.attributes[0].company.address}, 
          ${response.data.data.attributes[0].company.city}, ${response.data.data.attributes[0].company.province}`;
        this.city = response.data.data.attributes[0].company.city;
        this.academic = response.data.data.attributes[0].academic;
        this.typeJob = response.data.data.attributes[0].typeJob;
        this.nameCompany = response.data.data.attributes[0].company.name;
        this.link = response.data.data.attributes[0].company.linkWebsite;
        this.owner = response.data.data.attributes[0].company.owner;
        this.legality = response.data.data.attributes[0].company.legality;
        this.type = response.data.data.attributes[0].company.type;
        this.old = response.data.data.attributes[0].company.old;
        this.branches = response.data.data.attributes[0].company.branches;
        this.employee = response.data.data.attributes[0].company.employee;
        this.phone = response.data.data.attributes[0].company.phone;
        this.descriptionCompany = response.data.data.attributes[0].company.description;
        this.brousure = response.data.data.attributes[0].image;
        this.items.splice(1, 1, {
          text: response.data.data.attributes[0].name,
          disabled: true,
        });
      }
      this.skeleton = false;
