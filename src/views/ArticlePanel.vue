  ...
  methods: {
        ...
        try {
          ...
          if (
            response.data.data.attributes.data
              === 'Data Article Is Successfully Created'
          ) {
            this.hasSaved = true;
            this.status = true;
            ...
            this.hasSaved = true;
            this.status = false;
            this.message = 'sdata tidak berhasil disimpan';
            this.icon = '$warning';
          }
    ...
    async openDialogUpdate(item) {
      ...
      try {
        ...
        this.editedItemArticle.title = response.data.data.attributes[0].title;
        this.editedItemArticle.description = response.data.data.attributes[0].description;
