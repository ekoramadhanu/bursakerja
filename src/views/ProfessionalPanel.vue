    ...
    <v-main>
                ...
                <v-card>
                  <v-card-title class="primary">
                    <span class="headline white--text text-capitalize"
                      >menambah data profesional</span
                    >
                  </v-card-title>
                  ...
                  <v-card-text>
                    <v-form ref="form" lazy-validation>
                      <v-text-field
                        ...
                        prepend-icon="$idCard"
                        label="Id Pencari Kerja Profesional"
                        required
                      />
                      <v-text-field
                        ...
                        label="PIN Pencari Kerja Profesional"
                        required
                      />
                    </v-form>
                  </v-card-text>
      ...
      <v-dialog v-model="dialogUpdate" max-width="500px" persistent>
        <v-card>
          <v-card-title class="primary">
            <span class="headline white--text text-capitalize"
              >mengubah Pencari Kerja profesional</span
            >
          </v-card-title>
...
export default {
  ...
  methods: {
    ...
    saveAdd() {
      if (this.$refs.form.validate()) {
        ...
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-professional`,
          method: 'post',
          headers: {
    ...
    methodGetCardjobSeeker(page) {
      if (this.search === 'Semua') {
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-professional/${page}`,
          method: 'get',
          headers: {
            'x-api-key': this.$store.state.apiKey,
            authorization: `Bearer ${this.$cookies.get('token')}`,
        ...
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-professional-activate/${page}`,
          method: 'get',
          headers: {
            'x-api-key': this.$store.state.apiKey,
            authorization: `Bearer ${this.$cookies.get('token')}`,
        ...
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-professional-not-activate/${page}`,
          method: 'get',
          headers: {
            'x-api-key': this.$store.state.apiKey,
            authorization: `Bearer ${this.$cookies.get('token')}`,
  ...
  beforeCreate() {
    axios({
      baseURL: `${this.$store.state.domain}job-seeker/card-professional/1`,
      method: 'get',
      headers: {
        'x-api-key': this.$store.state.apiKey,
        authorization: `Bearer ${this.$cookies.get('token')}`,
