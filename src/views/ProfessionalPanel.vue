                  ...
                  <v-card-text class="size-max mx-auto">
                    <v-form ref="form" lazy-validation>
                      ...
                      <v-autocomplete
                        ...
                        item-text="name"
                        item-value="name"
                        label="Lokasi Pekerja Profesional"
                        v-if="!manually"
                        persistent-hint
                      ...
                      <v-select
                        ...
                        item-text="name"
                        item-value="name"
                        label="Pendidikan Terakhir Pekerja Sekolah"
                        :rules="schoolRules"
                        required
                      ></v-select>
                      <v-menu
                      ...
                      >
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field
                            ...
                            label="Tanggal Berakhir Pekerja Profesional"
                            :rules="expiredRules"
                            readonly
                            v-bind="attrs"
                            v-on="on"
