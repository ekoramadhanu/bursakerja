    ...
    <v-main>
      ...
      <v-dialog v-model="dialogUpdate" max-width="500px" persistent>
        <v-card>
          <v-card-title class="primary">
            <span class="headline white--text text-capitalize"
              >mengubah Pencari Kerja internship</span
            >
          </v-card-title>
...
export default {
  ...
  methods: {
    ...
    saveAdd() {
      if (this.$refs.form.validate()) {
        ...
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-internship`,
          method: 'post',
          headers: {
    ...
    methodGetCardjobSeeker(page) {
      if (this.search === 'Semua') {
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-internship/${page}`,
          method: 'get',
          headers: {
            'x-api-key': this.$store.state.apiKey,
            authorization: `Bearer ${this.$cookies.get('token')}`,
        ...
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-internship-activate/${page}`,
          method: 'get',
          headers: {
            'x-api-key': this.$store.state.apiKey,
            authorization: `Bearer ${this.$cookies.get('token')}`,
        ...
        axios({
          baseURL: `${this.$store.state.domain}job-seeker/card-internship-not-activate/${page}`,
          method: 'get',
          headers: {
            'x-api-key': this.$store.state.apiKey,
            authorization: `Bearer ${this.$cookies.get('token')}`,
  ...
  beforeCreate() {
    ...
    || this.$store.state.role === 'Informal'
      ...
      axios({
        baseURL: `${this.$store.state.domain}job-seeker/card-internship/1`,
        method: 'get',
        headers: {
          'x-api-key': this.$store.state.apiKey,
          authorization: `Bearer ${this.$cookies.get('token')}`,
