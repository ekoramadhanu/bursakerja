                ...
                <v-card>
                  ...
                  <v-card-text class="px-0 py-1 mx-auto size-max">
                    ...
                    <v-form ref="form" lazy-validation>
                      ...
                      />
                      <p class="mb-0 black--text text-capitalize">
                        <span class="font-family">Jenis Pekerjaan</span>
                        <span class="ml-1 error--text"> * </span>
                      </p>
                      <v-autocomplete
                        v-model="editedItemJobVacancy.tag"
                        :items="itemPosition"
                        item-text="name"
                        item-value="name"
                      ...
                      >
                        ...
                        <template v-slot:item="data">
                          <template
                            v-if="
                              data.item.constructor.name.toLowerCase() !==
                              'object'
                            "
                          >
                            <v-list-item-content
          ...
          <v-card-text class="px-0 py-1 mx-auto size-max">
            ...
            <v-form ref="form" lazy-validation v-if="!loadingDialog">
              ...
              >
                ...
                <template v-slot:item="data">
                  <template
                    v-if="data.item.constructor.name.toLowerCase() !== 'object'"
                  >
                    <v-list-item-content
                      v-text="data.item"
                    ></v-list-item-content>
...
export default {
  data: () => ({
    ...
    itemPosition: [],
    PositionRules: [(v) => !!v || 'Jenis Pekerjaan Tidak Boleh Kosong'],
    percentCompleted: 0,
  }),
  components: {
  ...
  methods: {
        ...
        try {
          ...
          const response = await axios({
            ...
            data: {
              ...
              tag: this.editedItemJobVacancy.tag,
            },
    ...
    async openDialogUpdate(item) {
      ...
      this.editedItemJobVacancy.description = response.data.data.attributes[0].description;
      this.editedItemJobVacancy.academic = response.data.data.attributes[0].academic;
      this.editedItemJobVacancy.tag = response.data.data.attributes[0].tag;
      this.editedItemJobVacancy.typeJob = response.data.data.attributes[0].typeJob;
      const reader = new FileReader();
      reader.onload = (e) => {
        this.editedItemJobVacancy.image = e.target.result;
      };
    ...
    async methodGetJobVacancy() {
      ...
      try {
        const response = await axios({
          baseURL: `${this.$store.state.domain}job-vacancy/company-pagination/${this.page}`,
          method: 'get',
          headers: header,
        });
