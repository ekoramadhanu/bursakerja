  ...
  beforeCreate() {
    axios({
      ...
      .then((response) => {
        ...
        let sex = null;
        let married = null;
        if (response.data.data.jobSeeker[0].frontDegree === '-') {
          frontDegree = '';
        } else {
          frontDegree = response.data.data.jobSeeker[0].frontDegree;
        }
        if (response.data.data.jobSeeker[0].backwardDegree === '-') {
          backkDegree = '';
        } else {
          backkDegree = response.data.data.jobSeeker[0].backwardDegree;
        }
        if (response.data.data.jobSeeker[0].sex === 'L') {
          sex = 'Laki-Laki';
        } else {
          sex = 'Perempuan';
        }
        if (response.data.data.jobSeeker[0].married === 'Sudah') {
        ...
        this.fullname = `${frontDegree} ${response.data.data.jobSeeker[0].fullname} ${backkDegree}`;
        this.date = `${response.data.data.jobSeeker[0].placeOfBirth}, 
        ...
        kec ${response.data.data.jobSeeker[0].district}, kab/kota ${response.data.data.jobSeeker[0].city},
        provinsi ${response.data.data.jobSeeker[0].province}`;
        ...
        this.items.splice(1, 1, {
          text: response.data.data.jobSeeker[0].fullname,
          disabled: true,
        });
      })
      .catch((error) => {
