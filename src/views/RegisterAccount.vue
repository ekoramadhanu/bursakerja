      ...
      if (this.$refs.form.validate()) {
        if (this.password !== this.repassword) {
          ...
          try {
            ...
            if (response.data.data.attributes.data === 'Email Has Been Used') {
              this.status = false;
              this.message = 'alamat email has been used';
            } else if (
              response.data.data.attributes.data === 'Bursa Card Cannot Activate'
            ) {
              this.status = false;
              this.message = 'kartu bursa tidak terdaftar silahkan hubungi pihak bursa kerja';
            } else if (
              response.data.data.attributes.data === 'Data Not Found'
            ) {
              this.status = false;
              this.message = 'kartu bursa tidak terdaftar silahkan hubungi pihak bursa kerja';
            } else {
