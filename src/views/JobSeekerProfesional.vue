...
export default {
  ...
  watch: {
    searchLocation() {
      ...
      fetch(`${this.$store.state.domain}professional/location`, {
        headers: {
    ...
    searchJob() {
      ...
      // Lazily load input items
      fetch(`${this.$store.state.domain}professional/position`, {
        headers: {
          'x-api-key': this.$store.state.apiKey,
        },
      })
    ...
    searchSchool() {
      ...
      // Lazily load input items
      fetch(`${this.$store.state.domain}professional/school`, {
        headers: {
          'x-api-key': this.$store.state.apiKey,
        },
      })
  ...
  methods: {
    ...
    methodGetJobSeeker(page) {
      ...
      axios({
        baseURL: `${this.$store.state.domain}professional/pagination-show/${page}`,
        method: 'get',
        headers: header,
      })
        .then((response) => {
  ...
  beforeCreate() {
    axios({
      baseURL: `${this.$store.state.domain}professional/pagination-show/1`,
      method: 'get',
      headers: {
        'x-api-key': this.$store.state.apiKey,
      },
